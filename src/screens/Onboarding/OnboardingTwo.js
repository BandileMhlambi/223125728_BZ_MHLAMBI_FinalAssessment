...
export default function OnboardingTwo({ navigation }) {
  return (
    <View style={styles.container}>
      <Image source={require('../../../Materials/01-Onboarding Page/Onboarding 2.png')} style={styles.image} resizeMode="contain" />
      <Text style={styles.title}>Book rooms easily</Text>
      <Text style={styles.text}>Select dates, guests and room types in a few taps.</Text>
